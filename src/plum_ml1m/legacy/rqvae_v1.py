"""Legacy first-pass RQ-VAE prototype.

Not part of the canonical SID-v2 reproduction path. The active implementation
used by current scripts lives in :mod:`plum_ml1m.legacy.sid.rqvae` until it is
fully promoted into the canonical package API.
"""
